...
class OffscreenRenderer(object):
    ...
    def render(self, scene, flags=RenderFlags.NONE, seg_node_map=None):
        ...
        self._renderer.focus_distance = self.focus_distance
        self._renderer.focus_range = self.focus_range
        self._renderer.bokeh_radius = self.bokeh_radius
        self._renderer.aberration = self.aberration
    ...
    def _create(self):
        if 'PYOPENGL_PLATFORM' not in os.environ:
            from utils.pyrender.platforms.pyglet_platform import PygletPlatform
            self._platform = PygletPlatform(self.viewport_width,
                                            self.viewport_height)
        elif os.environ['PYOPENGL_PLATFORM'] == 'egl':
            from utils.pyrender.platforms import egl
            ...
            from utils.pyrender.platforms.osmesa import OSMesaPlatform
